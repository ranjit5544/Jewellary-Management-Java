...
public class SilverCalculator extends javax.swing.JFrame {

    Connection con=null;
    Statement ps;
    ResultSet rs;
    public SilverCalculator() {
        initComponents();
        try{
	...
	ps=con.createStatement();
        ...
        while(rs.next())
	{
            sRate=rs.getString(1);
	}
        jSilverRate.setText(sRate);
        }
        catch(Exception e)
        {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Silver Rate");

        jSilverRate.setEditable(false);
        jSilverRate.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SilverCalculator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SilverCalculator().setVisible(true);
            }
        });
    }
