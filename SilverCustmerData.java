...
public class SilverCustmerData extends javax.swing.JFrame {
    ...
    int billNo;
    double netWeight,silverRate,totalAmount,majuri;
    public SilverCustmerData() {
        initComponents();
        currentDate();
        try{
    ...
    private void initComponents() {
        ...
        jSilverRate = new javax.swing.JTextField();
        ...
        jSilverRate.setEditable(false);
        jSilverRate.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
        jSilverRate.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jSilverRate.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jSilverRateActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jSilverRate, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jDate))))
                .addContainerGap())
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel7)
                    .addComponent(jSilverRate, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel9)
    ...
    private void jWeightKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jWeightKeyReleased
        try{
            ...
            double value2=Double.parseDouble(jSilverRate.getText());
    ...
    private void jSilverRateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jSilverRateActionPerformed
        // jGoldRate.setText("28000");
    }//GEN-LAST:event_jSilverRateActionPerformed
    ...
    void stockUpdate()
    {
        try{
            ...
            ps1=con.prepareStatement("UPDATE silverstock SET stock=? where cdate=?");
    ...
    void newButton()
    {
        ...
        try{
            ps=con.createStatement();
            rs=ps.executeQuery("select silcount from LOGIN");
            int count=0;
            while(rs.next())
            {
                count=rs.getInt(1);
    ...
    void saveButton()
    {
        try{
            ...
            silverRate=Double.parseDouble(jSilverRate.getText());
            totalAmount=Double.parseDouble(jTotalAmount.getText());
            date=jDate.getText();

            ps1=con.prepareStatement("insert into silvercustdata(bill_no,name,address,mobile_no,item_name,net_weight,silver_rate,amount,cdate) values(?,?,?,?,?,?,?,?,?)");
            ps1.setInt(1,billNo);
    ...
    void deleteButton()
    {
        try{
            ...
            ps1=con.prepareStatement("delete from silvercustdata where bill_no=?");
            ps1.setInt(1,str);
            ps1.executeUpdate();
    ...
    {
        jBillNo.setEditable(false);
        jSilverRate.setEditable(true);
        try{
            int str=Integer.parseInt(jBillNo.getText());
            ps1=con.prepareStatement("select * from silvercustdata where bill_no=?");
            ps1.setInt(1,str);
            rs=ps1.executeQuery();
            while(rs.next())
            {
                ...
                jSilverRate.setText(Double.toString(rs.getDouble(7)));
    ...
    void updateButton()
    {
        try{
            ...
            ps1=con.prepareStatement("UPDATE silvercustdata SET name=?,address=?,mobile_no=?,item_name=?,net_weight=?,silver_rate=?,amount=?,cdate=? where bill_no=?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SilverCustmerData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SilverCustmerData().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField jSilverRate;
